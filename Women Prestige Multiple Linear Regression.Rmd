...
########################################
png(file="images/R diagnostic plots Model2.png",
width=600, height=350)
layout(matrix(c(1,2,3,4),2,2)) # optional 4 graphs/page
plot(model2)
dev.off()
...
# diagnostic plots: Model2             #
########################################
png(file="images/R diagnostic plots Model3.png",
width=600, height=350)
layout(matrix(c(1,2,3,4),2,2)) # optional 4 graphs/page
plot(model3)
dev.off()
...
plot_ly() %>%
  ...
  layout(
    ...
    plot_bgcolor='red',
    scene = list(
      zaxis = list(gridcolor ='red', 
                   title = "Prestige",
                   zerolinewidth = 2,
                   zerolinecolor = '#ffff'),
      yaxis = list(gridcolor ='red', 
                   title = "Education",
                   zerolinewidth = 2,
                   zerolinecolor = '#ffff'),
      xaxis = list(gridcolor ='red', 
                   title = "Income",
                   zerolinewidth = 2,
                   zerolinecolor = '#ffff')
    )
